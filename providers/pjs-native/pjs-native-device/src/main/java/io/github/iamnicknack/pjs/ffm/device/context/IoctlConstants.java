...
public class IoctlConstants {
    ...
    public static final long _IOC_NRBITS = 8;
    public static final long _IOC_TYPEBITS = 8;
    public static final long _IOC_SIZEBITS = 14;
    public static final long _IOC_DIRBITS = 2;
    public static final long _IOC_NRSHIFT = 0;
    public static final long _IOC_NONE = 0;
    public static final long _IOC_READ = 2;
    public static final long _IOC_WRITE = 1;
