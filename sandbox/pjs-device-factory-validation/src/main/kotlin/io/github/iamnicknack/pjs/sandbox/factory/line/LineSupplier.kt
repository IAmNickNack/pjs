...
import io.github.iamnicknack.pjs.sandbox.factory.hardware.HardwareAllocations

/**
 * A component that provides a set of
 * [io.github.iamnicknack.pjs.sandbox.factory.hardware.HardwareAllocationIndex.Line] instances.
 */
fun interface LineSupplier {
    /**
     * Provides a set of [io.github.iamnicknack.pjs.sandbox.factory.hardware.HardwareAllocationIndex.Line] instances.
     * @return a set of [io.github.iamnicknack.pjs.sandbox.factory.hardware.HardwareAllocationIndex.Line] instances
     */
