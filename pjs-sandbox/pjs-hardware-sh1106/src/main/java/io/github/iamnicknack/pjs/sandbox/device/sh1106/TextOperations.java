...
public interface TextOperations {
    ...
    class Default implements TextOperations {
        ...
        public void drawText(int page, int column, String text) {
            displayOperations.setPosition(page, column);
            drawText(text);
        }
        ...
        public void drawText(String text) {
            ...
            displayOperations.setData(buffer.array(), 0, buffer.limit());
        }

        @Override
        public void clearText(int page, int column, int length) {
            displayOperations.setPosition(page, column);
            displayOperations.setData(new byte[length * 6], 0, length * 6);
        }

        @Override
        public void appendChar(char c) {
            displayOperations.setData(FontData.getCharacterData(c), 0, 6);
